...
function hideMoreText(card) {
    ...
    card.productName.nextSibling.remove();
...
function showMoreText(card) {
    ...
    let txt = '<div class="desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. A ad delectus distinctio dolore dolorem, ducimus fugiat</div>';

    // !!!! Я глянул в решение в конце понял что div.desc лучше писать на 76 строчке. Но так как я сделал это совсем дурной тон?

    // 6.2 внутри .product есть .productName, после него вставляем div.desc и текстом из переменной из п. 6.1
    card.productName.insertAdjacentHTML('afterend', txt);
